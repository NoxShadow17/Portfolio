...
const TERMINAL_COMMANDS = {
  ...
  skills: () => [
    { text: 'Languages:  Python, JavaScript, Java, C++, SQL', cls: 'highlight' },
    { text: 'AI/ML:      scikit-learn, NumPy, Pandas, RAG, Local Embeddings, Groq SDK' },
    { text: 'Web/Backend: Next.js 14, Node.js, Express, FastAPI, Flask, REST APIs, WebSockets' },
    { text: 'Databases:  Supabase Auth & RLS, PostgreSQL, PL/pgSQL, MySQL, Vector Search' },
    { text: 'Tools/CV:   Git, GitHub, Docker, YOLOv8, ONNX Runtime, ESP32, Streamlit' },
  ],
  projects: () => [
    { text: '1. Advanced Movie Recommendation System [AI/ML]', cls: 'highlight' },
    { text: '   → 60/40 Hybrid Cosine & Jaccard similarity, 40% genre penalty, 13-page React UI' },
    { text: '2. NeuroAssist — AI OS for Neurodivergent [AI/ML]', cls: 'highlight' },
    { text: '   → Groq SDK (Llama 3), Supabase Auth & RLS, PL/pgSQL streak triggers' },
    { text: '3. AVERT — Cattle Collision Prevention  [AI-oT]', cls: 'highlight' },
    { text: '   → YOLOv8 Small, ONNX edge export, asyncio WebSockets to ESP32' },
    { text: '4. Phishing URL & Email Detection        [CYBER]', cls: 'highlight' },
    { text: '   → XGBoost + Random Forest ensemble (97.3% accuracy)' },
    { text: '5. Real-Time Hand Detection System      [CV]', cls: 'highlight' },
    { text: '   → MediaPipe 21 landmark gesture recognition (30fps)' },
  ],
  contact: () => [
