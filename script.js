...
const TERMINAL_COMMANDS = {
  ...
  projects: () => [
    { text: '1. Neurodiverse Support System         [AI/ML]', cls: 'highlight' },
    { text: '   → Cognitive task simplification & adaptive UI' },
    { text: '2. CineMatch — Movie Recommender       [AI/ML]', cls: 'highlight' },
    { text: '   → Hybrid SVD + Content-based recommendation' },
    { text: '3. Phishing URL & Email Detection      [CYBER]', cls: 'highlight' },
    { text: '   → ML-based threat classification' },
    { text: '4. Real-Time Hand Detection            [CV]', cls: 'highlight' },
    { text: '   → Computer vision gesture recognition' },
    { text: '5. Diabetes Risk Prediction            [AI/ML]', cls: 'highlight' },
    { text: '   → Health data diagnostic modeling' },
  ],
  contact: () => [
